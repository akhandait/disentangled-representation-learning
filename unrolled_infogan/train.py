...
from models_mnist import Generator, Discriminator
...
parser.add_argument('--outDir', type=str, default='output_mnist_4',
...
# optimizerQ = optimizer(list(D.commonDQ.parameters()) + list(D.finalQ.parameters()), lr=opt.lrQ, betas=(0.5, 0.999))
...
# Create dataloader.
dataloader = DataLoader(Mnist(imgDirectory), batch_size=opt.batchSize, shuffle=True,
